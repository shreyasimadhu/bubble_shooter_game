...
window.onload = function() {
    ...
    function init() {
        // Load images
        images = loadImages(["bubble-img.png"]);
    ...
    function drawFrame() {
        ...
        context.fillText("Bubble-shooter: Create By Shereyase Madhu Shampa", 8, 37);
        context.fillText("Bubble-shooter: Create By Shereyase Madhu Shampa", 10, 36);
